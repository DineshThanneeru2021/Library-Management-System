...
public class BookController {
    ...
    @GetMapping("/countNoOfBooksByGenre")
    public ResponseEntity countNoOfBooksByGenre(@RequestParam("genre") Genre genre)
    {
        try{

            int result = bookService.countNoOfBooksByGenre(genre);
            return new ResponseEntity(result, HttpStatus.OK);
