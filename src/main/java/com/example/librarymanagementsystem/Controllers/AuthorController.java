...
public class AuthorController {
    ...
    @GetMapping("/getListOfBookTitlesByAuthor")
    public ResponseEntity getListOfBookTitlesByAuthor(@RequestParam("authorId") Integer authorId)
    {
        try{

            List<String> result = authorService.getListOfBookTitlesByAuthor(authorId);
            return new ResponseEntity(result, HttpStatus.OK);
